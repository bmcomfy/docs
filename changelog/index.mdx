...
<Update label="1.5.0" description="December 19, 2024">

# ComfyUI 1.5.0

Major update introducing new AI model support and training capabilities

• **New Cosmos Models**: Added support for Cosmos predict2 text-to-image (2B and 14B) and image-to-video models
• **LoRA Training**: Integrated LoRA training node with weight adapter scheme for custom model fine-tuning
• **Database Support**: Added SQLite database support for improved data management
• **Flux Improvements**: Enhanced Chroma TE compatibility with regular Flux models
• **Bug Fixes**: Fixed WebcamCapture IS_CHANGED signature issues
