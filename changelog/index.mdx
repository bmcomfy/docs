...
<Update label="2.2.0" description="January 27, 2025">

# ComfyUI 2.2.0

Major update introducing AI model support and database improvements

• Added support for Cosmos predict2 text-to-image models (2B and 14B variants)
• Introduced Cosmos predict2 image-to-video model capabilities
• Added SQLite database support for improved data management
• Enhanced LoRA training with new weight adapter scheme training node
• Fixed WebcamCapture functionality and improved Flux model compatibility
