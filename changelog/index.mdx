...
<Update label="2.0.0" description="January 27, 2025">

# ComfyUI 2.0.0

Major release with AI model support expansions and training capabilities
...
• Added built-in LoRA training node with weight adapter scheme
• Enhanced Flux compatibility with chroma TE support
