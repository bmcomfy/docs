...
<Update label="v1.1.0" description="December 19, 2024">

# ComfyUI 1.1.0

Major update with new AI models, training capabilities, and database improvements

• Added support for Cosmos predict2 text-to-image models (2B and 14B variants)
• Introduced Cosmos predict2 image-to-video model support
• Added LoRA Trainer node for training LoRAs in weight adapter scheme
